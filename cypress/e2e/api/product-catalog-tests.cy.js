...
describe('eLead Promo API - Product and Catalog Tests', () => {
  beforeEach(() => {
    ...
    cy.log(`🧪 Running Product and Catalog tests in ${environment.toUpperCase()} environment`)
  });

  describe('Product Catalog', () => {
    it('should get catalog index', () => {
      cy.apiRequest('GET', '/api/v1/catalog')
        .then((response) => {
    ...
    it('should get specific product details', () => {
      cy.apiRequest('GET', '/api/v1/products/1')
        .then((response) => {
          if (response.status === 200) {
            ...
            cy.log(`⚠️  Product details returned ${response.status} - product might not exist`)
    ...
    it('should handle non-existent product ID', () => {
      cy.apiRequest('GET', '/api/v1/products/99999')
        .then((response) => {
  ...
  describe('Product Categories', () => {
      ...
      cy.apiRequest('GET', '/api/v1/categories')
        .then((response) => {
          if (response.status === 200) {
            ...
            cy.log(`⚠️  Categories returned ${response.status} - might require authentication`)
    ...
    it('should get products by category', () => {
      cy.apiRequest('GET', '/api/v1/categories/1/products')
        .then((response) => {
          if (response.status === 200) {
            expect(response.body).to.have.property('data')
            expect(response.body.data).to.be.an('array')
  ...
  describe('Featured Products', () => {
    it('should get featured products', () => {
      cy.apiRequest('GET', '/api/v1/featured_products')
        .then((response) => {
          if (response.status === 200) {
            expect(response.body).to.have.property('data')
            expect(response.body.data).to.be.an('array')
  ...
  describe('Product Pricing', () => {
    it('should calculate product pricing', () => {
      ...
      cy.apiRequest('POST', '/api/v1/pricing/product_item_total_prices', pricingData)
        .then((response) => {
          if (response.status === 200) {
            expect(response.body).to.have.property('data')
    ...
    it('should handle pricing calculation with invalid product', () => {
      ...
      cy.apiRequest('POST', '/api/v1/pricing/product_item_total_prices', invalidPricingData)
        .then((response) => {
  ...
  describe('Gift Codes and Incentives', () => {
    it('should get incentive codes', () => {
      cy.apiRequest('GET', '/api/v1/incentive_codes')
        .then((response) => {
          if (response.status === 200) {
            expect(response.body).to.have.property('data')
            expect(response.body.data).to.be.an('array')
    ...
    it('should get bill me later codes', () => {
      cy.apiRequest('GET', '/api/v1/bill_me_later_codes')
        .then((response) => {
          if (response.status === 200) {
            expect(response.body).to.have.property('data')
            expect(response.body.data).to.be.an('array')
    ...
    it('should get AU codes', () => {
      cy.apiRequest('GET', '/api/v1/au_codes')
        .then((response) => {
          if (response.status === 200) {
            expect(response.body).to.have.property('data')
            expect(response.body.data).to.be.an('array')
  ...
  describe('Product Search and Filtering', () => {
    it('should search products by name', () => {
      cy.apiRequest('GET', '/api/v1/products?search=test')
        .then((response) => {
          if (response.status === 200) {
            expect(response.body).to.have.property('data')
            expect(response.body.data).to.be.an('array')
    ...
    it('should filter products by category', () => {
      cy.apiRequest('GET', '/api/v1/products?category_id=1')
        .then((response) => {
          if (response.status === 200) {
            expect(response.body).to.have.property('data')
            expect(response.body.data).to.be.an('array')
    ...
    it('should paginate products', () => {
      cy.apiRequest('GET', '/api/v1/products?page=1&per_page=10')
        .then((response) => {
          if (response.status === 200) {
            expect(response.body).to.have.property('data')
            expect(response.body.data).to.be.an('array')
  ...
  describe('Product Personalization', () => {
    it('should validate personalization options', () => {
      cy.apiRequest('GET', '/api/v1/products/1/personalization_options')
        .then((response) => {
          if (response.status === 200) {
            expect(response.body).to.have.property('data')
    ...
    it('should calculate pricing with personalization', () => {
      ...
      cy.apiRequest('POST', '/api/v1/pricing/product_item_total_prices', personalizedPricingData)
        .then((response) => {
          if (response.status === 200) {
            expect(response.body).to.have.property('data')
