...
describe('eLead Promo API - Address Management Tests', () => {
  ...
  describe('Countries and States', () => {
    it('should get countries list', () => {
      cy.apiRequest('GET', '/api/v1/countries', null, { headers: authHeaders })
        .then((response) => {
    ...
    it('should get states for a specific country', () => {
      cy.apiRequest('GET', '/api/v1/states?country_id=1', null, { headers: authHeaders })
        .then((response) => {
          expect(response.status).to.eq(200)
    ...
    it('should handle invalid country ID for states', () => {
      cy.apiRequest('GET', '/api/v1/states?country_id=99999', null, { headers: authHeaders })
        .then((response) => {
  ...
  describe('Billing Address', () => {
    it('should create billing address', () => {
      ...
      cy.apiRequest('POST', '/api/v1/billing_address', billingAddressData, { headers: authHeaders })
        .then((response) => {
          expect(response.status).to.eq(200)
          expect(response.body).to.have.property('billing_address')
          expect(response.body.billing_address).to.have.property('address_line')
          expect(response.body.billing_address.address_line).to.eq('123 Test Street')
    ...
    it('should update billing address', () => {
      ...
      cy.apiRequest('PUT', '/api/v1/billing_address', updateData, { headers: authHeaders })
        .then((response) => {
          expect(response.status).to.eq(200)
          expect(response.body).to.have.property('billing_address')
          expect(response.body.billing_address.address_line).to.eq('456 Updated Street')
    ...
    it('should reject billing address with missing required fields', () => {
      ...
      cy.apiRequest('POST', '/api/v1/billing_address', invalidData, { headers: authHeaders })
        .then((response) => {
  ...
  describe('Shipping Address', () => {
    it('should create shipping address', () => {
      ...
      cy.apiRequest('POST', '/api/v1/shipping_address', shippingAddressData, { headers: authHeaders })
        .then((response) => {
          expect(response.status).to.eq(200)
          ...
          expect(response.body.shipping_address.address_line).to.eq('789 Shipping Street')
          cy.log('✅ Shipping address created successfully')
        })
    })

    it('should get shipping addresses list', () => {
      cy.apiRequest('GET', '/api/v1/shipping_addresses', null, { headers: authHeaders })
        .then((response) => {
          expect(response.status).to.eq(200)
          expect(response.body).to.be.an('array')
    ...
    it('should get specific shipping address', () => {
      ...
      cy.apiRequest('POST', '/api/v1/shipping_address', shippingAddressData, { headers: authHeaders })
        .then((response) => {
          ...
          return cy.apiRequest('GET', `/api/v1/shipping_address/${addressId}`, null, { headers: authHeaders })
        })
        .then((response) => {
          expect(response.status).to.eq(200)
          expect(response.body).to.have.property('shipping_address')
    ...
    it('should update shipping address', () => {
      ...
      cy.apiRequest('PUT', '/api/v1/shipping_address', updateData, { headers: authHeaders })
        .then((response) => {
          expect(response.status).to.eq(200)
          expect(response.body).to.have.property('shipping_address')
          expect(response.body.shipping_address.address_line).to.eq('888 Updated Shipping Street')
    ...
    it('should delete shipping address', () => {
      ...
      cy.apiRequest('POST', '/api/v1/shipping_address', shippingAddressData, { headers: authHeaders })
        .then((response) => {
          ...
          return cy.apiRequest('DELETE', `/api/v1/shipping_address/${addressId}`, null, { headers: authHeaders })
        })
        .then((response) => {
          expect(response.status).to.eq(200)
    ...
    it('should reject shipping address with invalid country/state', () => {
      ...
      cy.apiRequest('POST', '/api/v1/shipping_address', invalidData, { headers: authHeaders })
        .then((response) => {
          expect(response.status).to.be.oneOf([400, 422])
  ...
  describe('Address Validation', () => {
    it('should validate phone number format', () => {
      ...
      cy.apiRequest('POST', '/api/v1/shipping_address', invalidPhoneData, { headers: authHeaders })
        .then((response) => {
          expect(response.status).to.be.oneOf([400, 422])
    ...
    it('should validate zip code format', () => {
      ...
      cy.apiRequest('POST', '/api/v1/shipping_address', invalidZipData, { headers: authHeaders })
        .then((response) => {
          expect(response.status).to.be.oneOf([400, 422])
