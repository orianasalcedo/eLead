...
describe('Address Management', () => {
  ...
  describe('Address Dropdown Functionality', () => {
    ...
    it('Selected Address Is Read-Only', () => {
      ...
      cy.get('[data-testid="selected-address"] input').should('have.attr', 'readonly');
      cy.get('[data-testid="selected-address"] textarea').should('have.attr', 'readonly');
  ...
  describe('Address Selection Behavior', () => {
    ...
    it('Persist Selection Across Steps', () => {
      ...
      cy.get('[data-testid="selected-address"]').invoke('text').as('selectedAddressText');
  ...
  describe('Address Display and UI', () => {
    it('Long Address Truncation/Wrapping', () => {
      ...
      cy.get('[data-testid="address-dropdown"]').click();
      cy.get('[data-testid="address-dropdown"] .dropdown-item[data-long-address="true"]').click();
