...
describe('Order Processing', () => {
  ...
  it('Edge Case Sale Transaction Not Created if Payment is Pending', () => {
    ...
    cy.log('Summary: Edge Case: Sale Transaction Not Created if Payment is Pending');
  ...
  it('Do Not Create Sale Transaction if Variant is Not Inventoried', () => {
    ...
    cy.log('Summary: Do Not Create Sale Transaction if Variant is Not Inventoried');
  ...
  it('Manual order confirmation does not override item acknowledgments', () => {
    ...
    cy.log('Summary: Manual order confirmation does not override item acknowledgments');
