...
describe('Email Notifications', () => {
  ...
  it('Send Order Confirmation to Invoice Emails configured in Admin', () => {
    ...
    cy.log(
      'Summary: Send Order Confirmation to Invoice Emails configured in Admin',
    )
  ...
  it('Incorrect provider email is rejected from acknowledging an item', () => {
    ...
    cy.log(
      'Summary: Incorrect provider email is rejected from acknowledging an item',
    )
  ...
  it('Admin attempts to send new password but email is missing or invalid', () => {
    ...
    cy.log(
      'Summary: Admin attempts to send new password but email is missing or invalid',
    )
  ...
  it('Admin edits messages in Payment Page Message Thank You Page and HTML Order Confirmation Email', () => {
    ...
    cy.log(
      'Summary: Admin edits messages in Payment Page Message, Thank You Page, and HTML Order Confirmation Email',
    )
  ...
  it('Admin configures Receive invoice notifications with up to 3 emails', () => {
    ...
    cy.log(
      'Summary: Admin configures “Receive invoice notifications” with up to 3 emails',
    )
  ...
  it('Admin fills partial Billing Information phone andor email', () => {
    ...
    cy.log(
      'Summary: Admin fills partial Billing Information (phone and/or email)',
    )
