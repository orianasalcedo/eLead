...
describe('Tax and Shipping', () => {
  ...
  it('No tax applied on shipping when shipping_taxable is missing', () => {
    ...
    cy.log('Summary: No tax applied on shipping when shipping_taxable is missing');
  ...
  it('Calculate tax on handling fee and or shipping if applicable', () => {
    ...
    cy.log('Summary: Calculate tax on handling fee and or shipping if applicable');
  ...
  it('Admin sees tax values for orders with different destination states', () => {
    ...
    cy.log('Summary: Admin sees tax values for orders with different destination states');
  ...
  it('Admin sees tax breakdown for an order with taxable and tax-exempt items', () => {
    ...
    cy.log('Summary: Admin sees tax breakdown for an order with taxable and tax-exempt items');
  ...
  it('Admin filters orders by multiple filters Site Payment and Shipping', () => {
    ...
    cy.log('Summary: Admin filters orders by multiple filters (Site, Payment, and Shipping)');
  ...
  it('Default view for incomplete shipping and billing information', () => {
    ...
    cy.log('Summary: Default view for incomplete shipping and billing information');
  ...
  it('Proceed to the payment step after selecting a shipping method', () => {
    ...
    cy.log('Summary: Proceed to the payment step after selecting a shipping method');
