...
`
  ...
  async setup() {
    ...
    if (hasSSH) {
      console.log(
        '✅ SSH está configurado, puedes usar SSH para clonar repositorios',
      )
    ...
    const commands = [
      {
        name: 'Frontend',
        command:
          'git clone -b eleadpromo-nextjs-dev https://github.com/rootstrap/eleadpromo-nextjs.git ./repos/eleadpromo-nextjs',
      },
      {
        name: 'Admin',
        command:
          'git clone -b e-lead-promo-admin-develop https://github.com/rootstrap/e-lead-promo-admin.git ./repos/e-lead-promo-admin',
      },
    ]
